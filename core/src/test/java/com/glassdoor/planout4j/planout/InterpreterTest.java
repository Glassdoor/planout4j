...
public class InterpreterTest {
    ...
    private final Map<String, Object> inputs = Helper.cast(Map.of("userid", 123454));
    ...
    public void testInterpreterOverrides() {
        ...
        Map<String, Object> overrides = Helper.cast(Map.of("specific_goal", false));
        ...
        Map<String, Object> wrongInputs = Helper.cast(Map.of("userid", 123453));
        overrides = Helper.cast(Map.of("userid", 123454));
