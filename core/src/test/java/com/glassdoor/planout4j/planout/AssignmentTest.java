...
public class AssignmentTest {
    ...
    public void testSetGetUniform() {
        Assignment a = new Assignment(tester_salt, null);
        Map<String, String> varNameToChoice = ImmutableMap.of("foo", "b", "bar", "a", "baz", "a");
        for (String var : varNameToChoice.keySet()) {
            a.set(var, new UniformChoice<>(ImmutableList.of("a", "b"), 4));
    ...
    public void testOverrides() {
        Map<String, Object> overrides = Helper.cast(ImmutableMap.of("x", 42, "y", 43));
    ...
    public void testReserved() {
        ...
        a.set("x", 42);
        assertEquals(ImmutableMap.of("x", 42), a.get("data"));
    }
